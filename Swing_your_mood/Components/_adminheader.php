...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <a class="navbar-brand" href="./index.php">
      <img src="../Images/logo.webp" alt="Logo" width="60" height="60" class="d-inline-block align-text-top"></a>
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </button>
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <a class="navbar-brand" href="../index.php">Dine & Cheer</a>
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link" aria-current="page" id="home_nav" target="_blank" href="../index.php">Visit Home</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" id="menu_nav" href="../Admin/index.php">Handle Orders</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" id="menu_nav" href="../Admin/acontact.php">Handle Contact Forms</a>
        </li>
      </ul>
      <?php
